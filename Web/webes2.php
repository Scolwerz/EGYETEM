...
<body>
	<style>
        body {
            ...
            text-align: center;
			background: linear-gradient(to bottom, <?php echo color($favorite_color); ?>, #000000);
        ...
        foreach ($lines as $line) {
            ...
            if ($stored_username === $username) {
                ...
                if ($stored_password === $password) {
                    ...
                    $conn = new mysqli("mysql.nethely.hu "scolwerz@gmail.com", "scolwerzsql123_", "webes2_adatok	");
